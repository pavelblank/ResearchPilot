# Skill: 12-Point Elite Extraction Protocol

When extracting a research paper, ALWAYS apply the full 12-point protocol:
...
Output format: Structured markdown with quotes, section-by-section details, keywords, and cross-references.
