...
**24/24 tests pass** — encryption, RAG cache, audit log, rate limiter, health endpoint, exception handler, keyword rules, Graphify filter, SSRF guard, tool-allowlist interceptor, path-traversal protection, filename standardisation, and graph cluster mode.
